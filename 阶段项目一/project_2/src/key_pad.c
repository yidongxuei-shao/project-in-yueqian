...
void set_postion_keypad(void)
{
    ...
    */
    /* 数字1 */
    number_1.x_start = 112;
    number_1.x_end = 192;
    number_1.y_start = 196;
    number_1.y_end = 239;

    /* 数字2 */
    number_2.x_start = 215;
    number_2.x_end = 295;
    number_2.y_start = 191;
    number_2.y_end = 240;

    /* 数字3 */
    number_3.x_start = 320;
    number_3.x_end = 403;
    number_3.y_start = 191;
    number_3.y_end = 240;

    /* 数字4 */
    number_4.x_start = 110;
    number_4.x_end = 193;
    number_4.y_start = 262;
    number_4.y_end = 310;

    /* 数字5 */
    number_5.x_start = 213;
    number_5.x_end = 298;
    number_5.y_start = 257;
    number_5.y_end = 311;

    /* 数字6 */
    number_6.x_start = 320;
    number_6.x_end = 406;
    number_6.y_start = 258;
    number_6.y_end = 311;

    /* 数字7 */
    number_7.x_start = 107;
    number_7.x_end = 195;
    number_7.y_start = 324;
    number_7.y_end = 378;

     /* 数字8 */
    number_8.x_start = 213;
    number_8.x_end = 298;
    number_8.y_start = 326;
    number_8.y_end = 378;

    /* 数字9 */
    number_9.x_start = 319;
    number_9.x_end = 407;
    number_9.y_start = 324;
    number_9.y_end = 378;

    /* 删除键 */
    number_del.x_start = 107;
    number_del.x_end = 298;
    number_del.y_start = 390;
    number_del.y_end = 446;

    /* 数字0 */
    number_0.x_start = 210;
    number_0.x_end = 298;
    number_0.y_start = 390;
    number_0.y_end = 445;

    /* 确认键 */
    number_ture.x_start = 321;
    number_ture.x_end = 408;
    number_ture.y_start = 391;
    number_ture.y_end = 445;
...
{
    user_msg.x_start = 250;
    user_msg.x_end = 573;
    user_msg.y_start = 167;
    user_msg.y_end = 256;

    recharge.x_start = 250;
    recharge.x_end = 537;
    recharge.y_start = 267;
    recharge.y_end = 367;
