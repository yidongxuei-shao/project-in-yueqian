...
int tcp_recv_picture(int connfd)
{
    ...
    //     return 0;
    // }
    if((fp = fopen("/home/shao/nfs/03_project/image/temp/3.jpg","ab+") ) == NULL )
    {
        printf("File.\n");
        // close(listenfd);
        exit(1);
    ...
    printf("======waiting for server's request======\n");
    // while(1){
...
{  
    ...
    // 服务器的IP地址来自程序的参数   
    if (inet_aton("192.168.12.112", &server_addr.sin_addr) == 0)  
    {  
